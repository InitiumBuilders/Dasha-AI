...
**Do:**
- Default JS (EvoSDK, npm `@dashevo/evo-sdk`) unless the user said Rust; ask only if genuinely ambiguous. Build from the knowledge pack §2 canonical flow and compact example — exact constructors, nonces, and BigInt revisions matter.
